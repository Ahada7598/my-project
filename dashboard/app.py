# dashboard/app.py - SQLITE VERSION OF YOUR ORIGINAL APP
...
def load_data():
    ...
    try:
        ...
        try:
            ...
            csv_path = "data/world_bank_indicators.csv"
...
class BiddingSystem:
    """Simple bidding system (uses JSON file)"""
...
def show_admin_dashboard():
    ...
    with tab4:
        # Show analytics from Viewer dashboard
